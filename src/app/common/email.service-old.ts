    ...
    return `
        <html lang="en">
            ...
            <body>
              ...
              <p>
                We are happy you signed up for Tournest. To start exploring please confirm
                your email address. Below is an OTP to confirm your email with.
              </p>
              <a>${this.otpCode} ${this.userDetails.firstName}</a>
              <p>
                <span>Welcome to Tournest!</span><br />
                <span>The Tournest Team</span>
              </p>
            </body>
          </html>
        `;
...
export class ForgotPasswordTemplate implements MailPurposeTemplate {
  ...
  getSubject() {
    return 'Tournest Account Password Reset';
  }
